...
*Table 3. Interlocking table obtain through RNA for bidirectional tracks. Considering only routes without lineBorders or stopBuffers*
...
The 14 routes in the original interlocking table (Table 2) have en exact equivalent with the 14 routes in the interlocking table generated by RNA (Table 3). It is clear that not safety functionality were ignored by RNA.

Routes 3,4,7,9,10,11,15 and 18 (Table 5) were created because RNA added signals T01,T02,T03,T04,T05 and T06 to protectt buffer stops and signals L07,L08,L09 and L10 to protect line borders. These new signals created new routes to stop prior the (relative or absolute) end of the network, increasing safety, and to add opposite routes than the originals, increasing mobility. These elements were not protected in the original interlocking table.

*Table 5. Interlocking table obtain through RNA considering "Analyze bufferStop" and "Analyze lineBorders" are marked.*
