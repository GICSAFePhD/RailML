...
The interlocking table generated by the RNA in G.4 for the new signalling must be compared with the interlocking table generated by Design4Rails.

#### H.1. Obtaining the interlocking tables using Design4Rail.

Design4Rail can be used as a visualization tool for both the layout and the interlocking table. This can be done following the next steps:

In Design4Rail software open the archive Example_1_B.railml" generated by RNA for this example, as shown in Figure 16.
...
#### H.2. Original interlocking table
...
*Table 3. Interlocking table obtain through RNA when the option "Analyze bufferStop" and "Analyze lineBorders" are mismarked.*
...
#### G.3. Interlocking table comparisson
...
The 14 routes in the original interlocking table have en exact equivalent in the interlocking table generated by RNA.

Routes 3,4,7,9,10,11,15 and 18 were created because RNA added signals T01,T02,T03,T04,T05 and T06 to protectt buffer stops and signals L07,L08,L09 and L10 to protect line borders. These new signals created new routes to stop prior the (relative or absolute) end of the network, increasing safety, and to add opposite routes than the originals, increasing mobility. There elements were not protected in the original interlocking table.
...
#### H.1. One-directional and bidirectional tracks
...
#### H.2. Minimum distance parameter
