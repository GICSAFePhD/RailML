...
from RailML.Infrastructure import tNavigability, tUsage, RTM_NetworkResource
...
class RTM_Relation(RTM_NetworkResource.RTM_NetworkResource):
	...
	def __init__(self):
		self.___navigability : tNavigability = tNavigability.tNavigability()
		# @AssociationType schemas.3.1.tNavigability
		self.___positionOnA : tUsage = tUsage.tUsage()
		self.___positionOnB : tUsage = tUsage.tUsage()
		# @AssociationType schemas.3.1.tUsage
		# @AssociationType schemas.3.1.tUsage
		self.___elementA : tElementWithIDref = tElementWithIDref.tElementWithIDref()
		self.___elementB : tElementWithIDref = tElementWithIDref.tElementWithIDref()
