#!/usr/bin/python
# -*- coding: UTF-8 -*-
from RailML.Interlocking.tTvdSectionTechnologyTypeExt import tTvdSectionTechnologyTypeExt
...
class TvdSection(TrackAsset):
	...
	def setIsBerthingTrack(self, aIsBerthingTrack : int):	#TODO DEFINED AS LONG
		self.___isBerthingTrack = aIsBerthingTrack

	def getIsBerthingTrack(self) -> int:	#TODO DEFINED AS LONG
		return self.___isBerthingTrack

	def setResidualRouteCancellationDelay(self, aResidualRouteCancellationDelay : int):	#TODO DEFINED AS duration
		self.___residualRouteCancellationDelay = aResidualRouteCancellationDelay

	def getResidualRouteCancellationDelay(self) -> int:	#TODO DEFINED AS duration
		return self.___residualRouteCancellationDelay

	def setPartialRouteReleaseDelay(self, aPartialRouteReleaseDelay : int):	#TODO DEFINED AS duration
		self.___partialRouteReleaseDelay = aPartialRouteReleaseDelay

	def getPartialRouteReleaseDelay(self) -> int:	#TODO DEFINED AS duration
	...
	def __init__(self):
		self.___isBerthingTrack : int = None	#TODO DEFINED AS LONG
		...
		self.___residualRouteCancellationDelay : int = None	#TODO DEFINED AS duration
		...
		self.___partialRouteReleaseDelay : int = None	#TODO DEFINED AS duration
