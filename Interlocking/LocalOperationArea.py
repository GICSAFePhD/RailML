...
class LocalOperationArea(RestrictedArea.RestrictedArea):
	...
	def DeactivationKey(self, aDeactivationKey : EntityILref):	# TODO *aDeactivationKey
	...
	def create_DeactivationKey(self):
		if self.DeactivationKey == None:
			self.DeactivationKey = []
		self.DeactivationKey.append(EntityILref.EntityILref())
	...
	def __init__(self):
		self.___deactivationKey : EntityILref = None
