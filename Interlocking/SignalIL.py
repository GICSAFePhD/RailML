...
class SignalIL(TrackAsset.TrackAsset):
	...
	def __init__(self):
		...
		self.___malfunctionSpeed : tSpeedKmPerHour = tSpeedKmPerHour.tSpeedKmPerHour()
		...
		self.___approachSpeed : tSpeedKmPerHour = tSpeedKmPerHour.tSpeedKmPerHour()
		# @AssociationType Common.tSpeedKmPerHour
		...
		self.___function : tSignalFunctionListExt = tSignalFunctionListExt.tSignalFunctionListExt()
		...
		self.___sightDistance : tLengthM = tLengthM.tLengthM()
		...
		self.___protectsBlockExit : EntityILref = EntityILref.EntityILref()
